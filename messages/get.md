...
You didn't provide a configuration variable to get. Specify one and try again. Run "sf config list" to see the configuration variables you've previously set. 
